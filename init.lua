...
vim.keymap.set({ 'i', 'c', 't', 'v', 'n' }, '<Del>', '<Esc>')
vim.keymap.set('t', '<Del>', [[<C-\><C-n>]], { silent = true }) -- Diagnostic keymaps
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        typescriptreact = { 'eslint_d', 'eslint', 'prettier_d', 'prettier', stop_after_first = true },
